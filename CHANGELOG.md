...
### Fixed
- Fixed `--tool-exclude` flag not working properly
- Fixed issue where `--tools` flag was displaying messages for user roles incorrectly
...
[0.0.2]: https://github.com/Sixeight/ccl/releases/tag/v0.0.2
